...
void AProject2Character::BeginPlay()
{
	// Call the base class
	Super::BeginPlay();
...
void AProject2Character::Death_Implementation()
{
...
void AProject2Character::Damage_Implementtation()
{
...
void AProject2Character::NotifyControllerChanged()
{
...
void AProject2Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AProject2Character::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AProject2Character::Look);
	}
	else
	{
...
void AProject2Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AProject2Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
